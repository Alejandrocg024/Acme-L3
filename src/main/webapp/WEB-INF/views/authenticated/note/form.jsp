...
<acme:form readonly="true">
	<acme:input-textbox code="authenticated.note.form.label.instantiationMoment" path="instantiationMoment"/>	
	...
	<acme:input-textbox code="authenticated.note.form.label.furtherInformationLink" path="furtherInformationLink"/>
</acme:form>