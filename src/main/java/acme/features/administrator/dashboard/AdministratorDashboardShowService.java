...
public class AdministratorDashboardShowService extends AbstractService<Administrator, AdministratorDashboard> {
	...
	public void load() {
		...
		statsOfUSD.calcDev(this.repository.findPriceOfferByCurrency("USD"));
		...
		statsOfEUR.calcDev(this.repository.findPriceOfferByCurrency("EUR"));
		...
		statsOfGBP.calcDev(this.repository.findPriceOfferByCurrency("GBP"));
