...
public class AuditorAuditingRecordCreateTest extends TestHarness {
	...
	public void test200Negative(final int auditRecordIndex, final String subject, final String assessment, final String startPeriod, final String endPeriod, final String mark, final String furtherInformationLink) {
	...
	public void test301Hacking() {
		...
		// para una auditoría que no fue creada por el auditor logeado
